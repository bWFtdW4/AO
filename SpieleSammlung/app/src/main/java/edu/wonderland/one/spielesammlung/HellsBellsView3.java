...
public class HellsBellsView3 extends View {
    ...
    public HellsBellsView3(Context context) {
        super(context);
        c = context;
    ...
    protected void onDraw(Canvas canvas){
        ...
        backgroundImage.setBounds(imageX, imageY, this.imageX + this.imageWidth, imageY + this.imageHeight);
