...
public class HellsBellsGame3 extends AppCompatActivity {
    ...
    private HellsBellsView3 hellsBellsView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
            ...
            if (!gameRun) {
                ...
                handler.postDelayed(runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        hellsBellsView3.setImageX(getRandomX());
                        hellsBellsView3.setImageY(getRandomY());

                        //invalidate() = redraw the view
                        hellsBellsView3.invalidate();
                    }
                }, delay);
                gameRun = true;
            }
        ...
        hellsBellsView3 = new HellsBellsView3(this);
        ...
        hellsBellsView3.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent e) {
                System.out.println("hellsBellsView touched");
                if (gameRun && hellsBellsView3.isHit((int)e.getX(),(int)e.getY())) {
        ...
        basicLinearLayout.addView(hellsBellsView3);
    ...
    public int getRandomX() {
        ...
        int max = hellsBellsView3.getCanvasWidth();
        //subtract the width of the image
        int realMax = max - hellsBellsView3.imageWidth;
        //return a random number between 0 and realMax
        return (new Random()).nextInt(realMax);
    }

    public int getRandomY() {
        int max = hellsBellsView3.getCanvasHeight();
        int realMax = max - hellsBellsView3.imageHeight;
        return (new Random()).nextInt(realMax);
    }
