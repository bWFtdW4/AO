...
public class GameVersion2 extends JPanel implements ActionListener {
    ...
    public GameVersion2(Image i, int w, int h) {
    ...
    //generate random coordinates with id add to CoordinateManager and draw the star
    public void generateCoordinates(){
        ...
        //draw the star
        starX = coordinateManager.getCoordinate(coordId).getCoordinateX();
        starY = coordinateManager.getCoordinate(coordId).getCoordinateY();
        System.out.println("Generating Star X: " + starX + " Star Y: " + starY);
