...
public class GameVersion4 extends JPanel implements ActionListener {
    ...
    private StarMakerPlus starMaker;

    public GameVersion4 (Image i, int w, int h) {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (action) {
                    ...
                    case KeyEvent.VK_P:
                        ...
                        getStarMaker();
                        System.out.println("starMaker: " + starMaker);
                        break;
                }
            }
    ...
    public StarMakerPlus getStarMaker() {
        System.out.println("StarMaker: " + starMaker);
        return starMaker;
    }
}
