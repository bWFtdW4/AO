...
public class GameVersion1c extends JPanel implements ActionListener {
    ...
    private int drawFrame, drawNewStarCounter, starOnScreen,drawNewSquareCounter, squareOnScreen;
    private boolean planetDiscovered = false, squarePlanetDiscovered = false;
    private int playerPoints, starCounter;
    private boolean gameOver, drawNext;
    private int gameOverCondition;

    public GameVersion1c(Image i, int w, int h) {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.fillOval(sqX, sqY, starWidth, starHeight);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (drawNext) {
            ...
            if (drawNewSquareCounter < 1){
                ...
                repaint();
                drawNewSquareCounter = drawFrame;
                squareOnScreen++;
                drawNext = false;
            }
    ...
    public void drawNewThing(Graphics g) {

        if (drawNext){
            System.out.println("Draw new thing");

            g.setColor(Color.YELLOW);
            g.fillRect(sqX + 20, sqY + 20, starWidth, starHeight);
